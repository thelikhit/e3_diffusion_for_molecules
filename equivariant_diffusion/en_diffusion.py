...
from qm9.scale_factor import input_scale_factor_mapping, no_input_scale_factor_mapping
...
class EnVariationalDiffusion(torch.nn.Module):
    ...
    def __init__(
        ...
        self.input_scale_factor_mapping = no_input_scale_factor_mapping
    ...
    def kl_prior(self, xh, node_mask, context=None):
    ...
    def compute_loss(self, x, h, node_mask, edge_mask, context, num_atoms=None):
    ...
    def sample(self, n_samples, n_nodes, node_mask, edge_mask, context, fix_noise=False, num_atoms=None):
        ...
        for s in reversed(range(0, self.T)):
            ...
            z = self.sample_p_zs_given_zt(s_array, t_array, z, node_mask, edge_mask, context=context, fix_noise=fix_noise)
